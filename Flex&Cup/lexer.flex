...
<YYINITIAL> [rR][eE][aA][lL][iI][zZ][aA][rR]_[sS][oO][lL][iI][cC][iI][tT][uU][dD]_[sS][oO][lL][iI][cC][iI][tT][uU][dD][eE][sS]     {return symbol(START_REQUESTS);}
...
//Componentes
<YYINITIAL> "\""(\s)*("ID")(\s)*"\""                       {return symbol(PARAM_NOMBRE_CAMPO);}
...
<YYINITIAL> "\""(\s)*("RESPUESTAS")(\s)*"\""                {return symbol(PARAM_RESPUESTAS);}
